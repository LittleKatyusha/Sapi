...
export const API_ENDPOINTS = {
  ...
  RPH: {
    ...
    // P0/P1/P2 — Anti-shrinkage audit module (under persediaan prefix)
    SLAUGHTER_BATCH: {
      DATA: '/api/rph/persediaan/slaughter-batch/data',
      STORE: '/api/rph/persediaan/slaughter-batch/store',
      SHOW: '/api/rph/persediaan/slaughter-batch/show',
      RECORD_WEIGHT: '/api/rph/persediaan/slaughter-batch/record-weight',
      REQUEST_CORRECTION: '/api/rph/persediaan/slaughter-batch/request-correction',
      APPROVE_CORRECTION: '/api/rph/persediaan/slaughter-batch/approve-correction',
      REJECT_CORRECTION: '/api/rph/persediaan/slaughter-batch/reject-correction',
      ADD_LOSS: '/api/rph/persediaan/slaughter-batch/add-loss',
      RECONCILE: '/api/rph/persediaan/slaughter-batch/reconcile',
      CLOSE: '/api/rph/persediaan/slaughter-batch/close',
    },
    ALERTS: {
      DATA: '/api/rph/persediaan/alerts/data',
      SHOW: '/api/rph/persediaan/alerts/show',
      ACKNOWLEDGE: '/api/rph/persediaan/alerts/acknowledge',
      RESOLVE: '/api/rph/persediaan/alerts/resolve',
      SUMMARY: '/api/rph/persediaan/alerts/summary',
    },
    YIELD_BASELINE: {
      DATA: '/api/rph/persediaan/yield-baseline/data',
      OPTIONS: '/api/rph/persediaan/yield-baseline/options',
      SHOW: '/api/rph/persediaan/yield-baseline/show',
      STORE: '/api/rph/persediaan/yield-baseline/store',
      UPDATE: '/api/rph/persediaan/yield-baseline/update',
      DELETE: '/api/rph/persediaan/yield-baseline/hapus',
    },
    DASHBOARD: {
      SUMMARY: '/api/rph/persediaan/dashboard/summary',
      BATCH_TIMELINE: '/api/rph/persediaan/dashboard/batch-timeline',
      BATCH_DETAIL: '/api/rph/persediaan/dashboard/batch-detail',
    },
    REPORTS: {
      SHRINKAGE: '/api/rph/persediaan/reports/shrinkage',
      UNEXPLAINED_LOSS: '/api/rph/persediaan/reports/unexplained-loss',
      RECONCILIATION: '/api/rph/persediaan/reports/reconciliation',
      RISK: '/api/rph/persediaan/reports/risk',
      CORRECTIONS: '/api/rph/persediaan/reports/corrections',
      ALERTS: '/api/rph/persediaan/reports/alerts',
    },
    RISK_SCORE: {
      DATA: '/api/rph/persediaan/risk-score/data',
      RECOMPUTE: '/api/rph/persediaan/risk-score/recompute',
    },
    INVENTORY_RECONCILIATION: {
      DATA: '/api/rph/persediaan/inventory-reconciliation/data',
      SHOW: '/api/rph/persediaan/inventory-reconciliation/show',
      STORE: '/api/rph/persediaan/inventory-reconciliation/store',
      ENTER_COUNT: '/api/rph/persediaan/inventory-reconciliation/enter-count',
      VERIFY: '/api/rph/persediaan/inventory-reconciliation/verify',
    },
    PENJUALAN_BONING: {
