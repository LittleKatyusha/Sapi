...
import { FileText, Download, Calendar, AlertCircle, FileCheck, Users, CalendarDays } from 'lucide-react';
import LaporanPembelianService from '../../services/laporanPembelianService';

const LaporanSemuaSupplierPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const blob = await LaporanPembelianService.downloadPdfReport('getReportAllSupplier', {
      ...
      link.href = url;
      link.download = `LAPORAN_SEMUA_SUPPLIER_${startDate}_${endDate}.pdf`;
    ...
    <div className="space-y-6">
      ...
      <div className="bg-white p-6 rounded-xl shadow-md">
        <div className="flex items-center justify-between mb-4">
          <div className="flex items-center">
            ...
            <div>
              <h1 className="text-2xl font-bold text-gray-800">Laporan Semua Supplier</h1>
              <p className="text-gray-600 text-sm">Generate laporan pembelian dari semua supplier berdasarkan periode</p>
            </div>
          </div>
          <div className="hidden md:flex items-center bg-green-50 px-4 py-2 rounded-lg">
      ...
      <div className="bg-gradient-to-r from-green-50 to-emerald-50 p-6 rounded-xl border border-green-200">
        <div className="flex items-start">
          ...
          <div className="ml-4">
            <h3 className="text-lg font-semibold text-green-800 mb-2">Informasi Laporan</h3>
            <div className="text-green-700 space-y-1">
              <p className="flex items-center">
                <span className="w-2 h-2 bg-green-400 rounded-full mr-2"></span>
                Laporan akan menampilkan semua transaksi pembelian dari seluruh supplier dalam periode yang dipilih
              </p>
              <p className="flex items-center">
                <span className="w-2 h-2 bg-green-400 rounded-full mr-2"></span>
                Format laporan: PDF dengan detail lengkap per supplier dan total keseluruhan
              </p>
              <p className="flex items-center">
                <span className="w-2 h-2 bg-green-400 rounded-full mr-2"></span>
...
export default LaporanSemuaSupplierPage;
