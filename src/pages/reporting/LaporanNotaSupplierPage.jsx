...
import { FileText, Download, AlertCircle, Calendar, FileCheck, CalendarDays } from 'lucide-react';
...
const LaporanNotaSupplierPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      link.href = url;
      link.download = `LAPORAN_NOTA_SUPPLIER_${startDate}_${endDate}.pdf`;
        ...
        <div className="flex items-center justify-between mb-4">
          <div className="flex items-center">
            ...
            <div>
              ...
              <p className="text-gray-600 text-sm">Generate laporan pembelian per nota supplier berdasarkan periode</p>
            </div>
          </div>
          ...
          <div className="ml-4">
            ...
            <div className="text-blue-700 space-y-1">
              <p className="flex items-center">
                ...
                Laporan akan menampilkan detail pembelian per nota supplier dalam periode yang dipilih
              </p>
              <p className="flex items-center">
                <span className="w-2 h-2 bg-blue-400 rounded-full mr-2"></span>
