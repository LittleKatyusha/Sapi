...
export default function PenerimaanWarehousePage() {
  ...
  const fetch = useCallback(async () => {
    ...
    try {
      const res = tab === 'feedmil' 
        ? await WarehouseService.getPenerimaanFeedmil()
        : await WarehouseService.getPenerimaanOvk();
  ...
  return (
    <div className="p-6 max-w-7xl mx-auto">
      <h1 className="text-2xl font-bold mb-4">Penerimaan Warehouse</h1>
