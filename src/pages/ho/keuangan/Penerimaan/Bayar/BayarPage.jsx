...
const BayarPenerimaanHoPage = () => {
  const { pid } = useParams();
  const navigate = useNavigate();
  const { loading, error, bayar, fetchDetail } = usePenerimaanHo();
  ...
  const loadDetail = async () => {
    ...
    if (result.success && result.data) {
      setPembayaran(result.data.pembayaran || result.data);
      ...
      <div className="max-w-[1400px] mx-auto space-y-5">
        ...
        {pembayaran && (
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
            ...
            <div className="bg-white rounded-xl border border-gray-100 p-4 shadow-sm">
              <p className="text-xs text-gray-500 font-medium uppercase">Sudah Diterima</p>
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-5">
              ...
              <form onSubmit={handleSubmit}>
                ...
                >
                  ...
                  {submitLoading ? 'Menyimpan...' : 'Simpan Penerimaan'}
                </button>
                ...
                <DataTable
                  ...
                  noDataComponent={
                    <div className="py-10 text-center">
                      ...
                      <p className="text-gray-500 text-sm">Belum ada penerimaan</p>
                    </div>
                  }
...
export default BayarPenerimaanHoPage;
