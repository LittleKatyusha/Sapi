...
import { Search, RotateCcw, ChevronDown, ChevronUp, Filter, Calendar, Truck, Hash, Tag, FileText, Receipt } from 'lucide-react';
        ...
        <div className="px-5 pb-5 border-t border-gray-100">
          ...
          {hasActiveFilters && (
            <div className="py-4 flex flex-wrap gap-2 items-center">
              ...
              {filters.jumlah && (
                <ActiveFilterBadge label="Jumlah" value={filters.jumlah} onRemove={() => removeFilter('jumlah')} />
              )}
              {filters.jenis_pembelian && (
                <ActiveFilterBadge
                  label="Jenis"
                  value={tipePembelianOptions.find(o => String(o.value) === String(filters.jenis_pembelian))?.label || filters.jenis_pembelian}
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 pt-4">
            ...
            <InputField
              ...
              onChange={(v) => handleChange('jumlah', v)}
