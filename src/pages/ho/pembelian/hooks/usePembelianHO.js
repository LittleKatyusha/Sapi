    ...
    const createPembelian = useCallback(async (pembelianData, supplierOptions = []) => {
        ...
        try {
            ...
            const headerData = {
                ...
                id_farm: pembelianData.id_farm ? parseInt(pembelianData.id_farm) : null,
        ...
        try {
            ...
            if (isHeader) {
                ...
                requestData = {
                    ...
                    id_farm: (data.idFarm || data.id_farm) ? parseInt(data.idFarm || data.id_farm) : null,
    ...
    const saveHeaderOnly = useCallback(async (headerData, supplierOptions = []) => {
        ...
        try {
            ...
            const requestData = {
                ...
                id_farm: headerData.id_farm ? parseInt(headerData.id_farm) : null,
