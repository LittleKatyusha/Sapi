...
// Hooks
import { usePembayaranKasDetail } from './hooks/usePembayaranKasDetail';
import { usePembayaranKasInfo } from './hooks/usePembayaranKasInfo';
...
import AddPaymentKasModal from './modals/AddPaymentKasModal';
...
const KeuanganKasDetailPage = () => {
    ...
    const getInfoCard = useCallback(async (pid) => {
        console.log('🔄 Keuangan Kas Info Card: Fetching with pid:', pid);
        try {
            ...
            console.log('🔄 Keuangan Kas Info Card: Response:', response);
    ...
    const getDetail = useCallback(async (idPembayaran) => {
        console.log('🔄 Keuangan Kas Table: Fetching payment details with id_pembayaran:', idPembayaran);
        try {
            ...
            console.log('🔄 Keuangan Kas Table: Payment details response:', response);
    ...
    const {
        ...
        loading: infoLoading,
        error: infoError
    } = usePembayaranKasInfo(id, getInfoCard);
    ...
    const {
        ...
        notification,
        setNotification
    } = usePembayaranKasDetail(infoData?.id_pembayaran, getDetail);
                        ...
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                <h1 className="text-3xl sm:text-4xl font-bold bg-gradient-to-r from-gray-800 to-gray-600 bg-clip-text text-transparent mb-2 flex items-center gap-3">
                                    ...
                                    Detail Pembayaran Keuangan Kas
                                </h1>
                    ...
                    <div className="px-6 py-4 bg-gray-50 border-b border-gray-200">
                        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    <h2 className="text-lg font-bold text-gray-900">Detail Pembayaran Keuangan Kas</h2>
...
export default KeuanganKasDetailPage;