...
const AddEditPembelianOVKPage = () => {
    ...
    useEffect(() => {
        console.log('投 AddEditPembelianOVKPage: Supplier options received:', supplierOptionsToShow.length, 'suppliers');
        ...
        if (isEdit && id && supplierOptions.length > 0 && officeOptions.length > 0 && farmOptions.length > 0 && jenisPembelianOptions.length > 0 && !editDataLoaded.current) { // Wait for all options to load first
            const loadEditData = async () => {
                try {
                    ...
                    console.log('剥 Getting header and detail data from /show endpoint for PID:', id);
                    ...
                    if (!showResponse.data || showResponse.data.length === 0) {
                        console.log('笶・No data from /show endpoint');
                    ...
                    if (headerData) {
                        ...
                        console.log('剥 OVK Edit Data Loading Debug:', {
                            dataSource,
                ...
                <div className="bg-white rounded-none sm:rounded-none p-4 sm:p-6 shadow-xl border border-gray-100">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 sm:gap-6">
                        ...
                        <div>
                            ...
                            {!jenisPembelianLoading && !jenisPembelianError && (
                                <p className="text-xs text-orange-600 mt-1">
                                    庁 Jenis pembelian untuk klasifikasi OVK
                                </p>
                            )}
                        </div>
                        ...
                        <div>
                            ...
                            />
                            <p className="text-xs text-blue-600 mt-1">
                                庁 Total seluruh biaya (truck + lain-lain + pembelian)
                            </p>
                        </div>
                ...
                <div className="bg-white rounded-none sm:rounded-none p-4 sm:p-6 shadow-xl border border-gray-100">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-4 sm:gap-6 mb-6">
                        ...
                        <div>
                            ...
                            />
                            {parameterLoading && (
                                <p className="text-xs text-blue-600 mt-1">売 Memuat klasifikasi OVK...</p>
                            )}
                            {parameterError && (
                                <p className="text-xs text-red-600 mt-1">笶・Error: {parameterError}</p>
                            )}
                        </div>
                                        ...
                                        >
                                            ...
                                            <div className="space-y-2">
                                                <h3 className={`text-xl font-bold transition-all duration-500 ${
                                                    ...
                                                    {isDragOver ? '脂 Drop file di sini!' : '刀 Upload File Dokumen OVK'}
                                                </h3>
