...
const PengajuanCard = ({ data, index, onEdit, onDelete, onDetail }) => {
        ...
        <div className="bg-white rounded-2xl shadow-lg border border-gray-100 p-4 hover:shadow-xl transition-shadow duration-300">
            ...
            <div className="flex items-center justify-between mb-4 pb-3 border-b border-gray-200">
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        <h3 className="font-bold text-gray-800 text-lg">{data.barang_yang_diajukan || '-'}</h3>
            ...
            <div className="space-y-3">
                ...
                <div className="flex items-start gap-3 p-3 bg-gray-50 rounded-lg">
                    ...
                    <div className="flex-1 min-w-0">
                        ...
                        <p className="font-semibold text-gray-800 text-sm">
                            {data.tgl_pengajuan ? new Date(data.tgl_pengajuan).toLocaleDateString('id-ID', {
                                day: '2-digit',
                                month: 'long',
                                year: 'numeric'
                            }) : '-'}
                ...
                <div className="flex items-start gap-3 p-3 bg-green-50 rounded-lg">
                    ...
                    <div className="flex-1 min-w-0">
                        <p className="text-xs text-gray-500 mb-1">Jenis Pengajuan</p>
                        <p className="font-semibold text-gray-800 text-sm break-words">
                ...
                <div className="flex items-start gap-3 p-3 bg-orange-50 rounded-lg">
                    ...
                    <div className="flex-1 min-w-0">
                        <p className="text-xs text-gray-500 mb-1">Yang Mengajukan</p>
                        <p className="font-semibold text-gray-800 text-sm break-words">
                ...
                <div className="grid grid-cols-2 gap-3">
                    <div className="flex items-start gap-2 p-3 bg-yellow-50 rounded-lg">
                        ...
                        <div className="flex-1 min-w-0">
                            ...
                            <p className="font-bold text-yellow-700 text-sm break-words">
                    ...
                    <div className="flex items-start gap-2 p-3 bg-indigo-50 rounded-lg">
                        ...
                        <div className="flex-1 min-w-0">
                            ...
                            <span className={`inline-flex px-2 py-1 text-xs font-medium rounded-lg ${getStatusColor(data.status)}`}>
                                {data.status || 'Pending'}
                            </span>
                        </div>
                    </div>
