...
import { X, FileSpreadsheet, FileText, Loader2, Calendar, AlertTriangle, CircleDot, Building2 } from 'lucide-react';
...
const EMPTY = {
    start_date: '', end_date: '', status: '', rph: '', payment_status: '',
};
...
const ExportPenjualanSapiModal = ({ isOpen, onClose, onConfirm, loading = false, initialFilters = {} }) => {
                ...
                <div className="p-6 space-y-4">
                    ...
                    <div>
                        ...
                        <p className="text-xs text-gray-500 mt-1.5">
                            {format === 'excel'
                                ...
                                : 'PDF: rekap ringkasan + detail, cocok untuk laporan management.'}
                        </p>
                    </div>
                    ...
                    <div className="border-t border-gray-100 pt-4">
                        ...
                        <div className="space-y-3">
                            <div>
                                <label className="block text-xs font-medium text-gray-700 mb-1.5"><Building2 className="w-3.5 h-3.5 inline mr-1" />RPH</label>
                                <input
                                    type="text"
                                    value={filters.rph}
                                    onChange={(e) => handleChange('rph', e.target.value)}
                                    placeholder="Cari nama RPH..."
...
export default ExportPenjualanSapiModal;
