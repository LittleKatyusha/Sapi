...
const PenjualanOVKTable = ({
    ...
    const NoDataComponent = () => (
        <div className="flex flex-col items-center justify-center py-20 text-gray-500">
            ...
            <p className="text-lg font-medium">Tidak ada data penjualan OVK</p>
                ...
                <div className="flex items-center justify-between gap-4 flex-wrap">
                    <SearchContainer>
                        <SearchInput
                            ref={searchInputRef}
                            type="text"
                            placeholder="Cari faktur, nama OVK, sopir..."
                            value={searchTerm}
...
export default PenjualanOVKTable;