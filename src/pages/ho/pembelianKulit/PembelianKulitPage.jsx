...
import PembelianKulitCard from './components/PembelianKulitCard';
    ...
    const handleDeletePembelian = useCallback(async (pembelian) => {
        try {
            ...
            if (result.success) {
                setNotification({
                    type: 'success',
                    message: result.message || 'Data pembelian kulit berhasil dihapus'
                });
            ...
            setNotification({
                type: 'error',
                message: error.message || 'Terjadi kesalahan saat menghapus data pembelian kulit'
            });
        }
    }, [deletePembelian]);
    ...
    return (
        <>
            ...
            <style>{`
                ...
                /* Sticky Action Column Styles - Specific to Pembelian Kulit Page */
                .pembelian-kulit-table .rdt_TableHeadRow .rdt_TableCol:nth-child(2),
                .pembelian-kulit-table .rdt_TableHeadRow th:nth-child(2) {
                ...
                .pembelian-kulit-table .rdt_TableBodyRow .rdt_TableCell:nth-child(2),
                .pembelian-kulit-table .rdt_TableBodyRow td:nth-child(2) {
                    position: sticky !important;
                    left: 60px !important;
                ...
                .pembelian-kulit-table .rdt_TableBodyRow:hover .rdt_TableCell:nth-child(2),
                .pembelian-kulit-table .rdt_TableBodyRow:hover td:nth-child(2) {
                    background-color: #f9fafb !important;
                }
                
                /* Additional selectors for better compatibility */
                .pembelian-kulit-table table thead tr th:nth-child(2) {
                    position: sticky !important;
                    left: 60px !important;
                    z-index: 1001 !important;
                    background-color: #f8fafc !important;
                ...
                .pembelian-kulit-table table tbody tr td:nth-child(2) {
                    position: sticky !important;
                    left: 60px !important;
                    z-index: 998 !important;
                    background-color: #ffffff !important;
                ...
                .pembelian-kulit-table table tbody tr:hover td:nth-child(2) {
                    background-color: #f9fafb !important;
                }
            ...
            <div className="w-full max-w-none mx-0 space-y-6 md:space-y-8">
                    ...
                    <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                        <div>
                            ...
                            <p className="text-gray-600 text-sm sm:text-base">
                                Kelola data pembelian kulit untuk ternak
                            </p>
                        </div>
                ...
                <div className="grid grid-cols-1 gap-3 sm:gap-4 md:gap-6 sm:grid-cols-2 md:grid-cols-4">
                    ...
                    <div className="bg-gradient-to-br from-emerald-400 to-emerald-500 text-white p-4 sm:p-6 rounded-xl sm:rounded-2xl shadow-lg hover:shadow-xl transition-shadow duration-300">
                        <h3 className="text-sm sm:text-base font-medium opacity-90 mb-2">Total Kulit</h3>
                        <p className="text-2xl sm:text-3xl lg:text-4xl font-bold">{stats.totalKulit}</p>
                    </div>
                ...
                <div className="bg-white rounded-lg shadow-lg border border-gray-100 relative hidden md:block">
                    ...
                    >
                        <div style={{ minWidth: '1200px' }}>
                            ...
                            data={filteredData}
                            pagination={false}
                            className="pembelian-kulit-table"
                            customStyles={{
                                ...customTableStyles,
                                tableWrapper: {
                            ...
                            noDataComponent={
                                <div className="text-center py-12">
                                    {error ? (
                                        ...
                                        <p className="text-gray-500 text-lg">Tidak ada data pembelian kulit ditemukan</p>
                                    )}
                                </div>
                            }
                            responsive={false}
