...
const AddEditSatuanModal = ({ 
  ...
  const validateForm = useCallback(() => {
    ...
    if (!formData.name.trim()) {
      newErrors.name = 'Nama satuan wajib diisi';
    } else if (formData.name.length > 200) {
      newErrors.name = 'Nama satuan maksimal 200 karakter';
    }
      ...
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-2xl max-h-[90vh] overflow-y-auto">
        ...
        <div className="flex items-center justify-between p-6 border-b border-gray-200">
          <h2 className="text-2xl font-bold text-gray-900">
            {item ? 'Edit Satuan' : 'Tambah Satuan'}
          </h2>
          <button
            onClick={onClose}
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-6">
          ...
          <div>
            ...
            <input
              ...
              placeholder="Masukkan nama satuan (contoh: Kg, Liter, Ekor)"
              disabled={isSubmitting}
              maxLength={200}
            />
            {errors.name && (
...
export default AddEditSatuanModal;