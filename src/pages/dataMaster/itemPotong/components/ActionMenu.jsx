...
const ActionMenu = ({ item, onEdit, onDelete, onClose, buttonRef }) => {
  ...
  const actions = [
    { label: 'Edit', icon: Edit, onClick: () => onEdit(item), bg: 'bg-amber-100', text: 'text-amber-600', description: 'Ubah data item potong' },
    { divider: true },
    { label: 'Hapus', icon: Trash2, onClick: () => onDelete(item), bg: 'bg-red-100', text: 'text-red-600', description: 'Hapus data item potong' },
  ];
