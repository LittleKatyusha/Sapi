...
import ActionButton from "./klasifikasiFeedmil/components/ActionButton";

// Komponen dan hooks terpisah
import CardView from "./klasifikasiFeedmil/components/CardView";
import AddEditKlasifikasiFeedmilModal from "./klasifikasiFeedmil/modals/AddEditKlasifikasiFeedmilModal";
import KlasifikasiFeedmilDetailModal from "./klasifikasiFeedmil/modals/KlasifikasiFeedmilDetailModal";
import DeleteConfirmationModal from "./klasifikasiFeedmil/modals/DeleteConfirmationModal";
import useKlasifikasiFeedmil from "./klasifikasiFeedmil/hooks/useKlasifikasiFeedmil";
import customTableStyles from "./klasifikasiFeedmil/constants/tableStyles";

// Main Page
const KlasifikasiFeedmilPage = () => {
  // State
  ...
  const handleSave = useCallback(async (data) => {
    try {
      if (editData) {
        await updateKlasifikasiFeedmil(editData.pid || editData.pubid, data);
      } else {
        await createKlasifikasiFeedmil(data);
      }
  ...
  }, [editData, updateKlasifikasiFeedmil, createKlasifikasiFeedmil]);
  ...
  const handleConfirmDelete = useCallback(async () => {
    ...
    setIsDeleting(true);
    try {
      await deleteKlasifikasiFeedmil(deleteData.pid || deleteData.pubid);
      setDeleteData(null);
    } catch (err) {
  ...
  }, [deleteData, deleteKlasifikasiFeedmil]);
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100 p-2 sm:p-4 md:p-6">
      <div className="max-w-7xl mx-auto space-y-6 sm:space-y-8">
          ...
          <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            <div>
              <h1 className="text-2xl sm:text-3xl font-bold text-gray-800 mb-1 sm:mb-2">
                Manajemen Klasifikasi Feedmil
              </h1>
              <p className="text-gray-600 text-sm sm:text-base">
                Kelola data klasifikasi pakan ternak (feedmil)
              </p>
            </div>
        ...
        <div className="bg-white rounded-2xl p-3 sm:p-6 shadow-lg border border-gray-100">
          <div className="flex flex-col gap-3 sm:flex-row sm:gap-4 sm:items-center sm:justify-between">
            <div className="relative flex-1 max-w-full sm:max-w-md">
              ...
              <input
                type="text"
                placeholder="Cari klasifikasi feedmil..."
                value={searchTerm}
                ...
                <DataTable
                  ...
                  noDataComponent={
                    <div className="text-center py-12">
                      <p className="text-gray-500 text-lg">Tidak ada data klasifikasi feedmil ditemukan</p>
                    </div>
                  }
        ...
        {(showAddModal || showEditModal) && (
          <AddEditKlasifikasiFeedmilModal
            item={editData}
            onClose={() => {
              setShowAddModal(false);
              setShowEditModal(false);
        ...
        {deleteData && (
          <DeleteConfirmationModal
            ...
            message={`Apakah Anda yakin ingin menghapus klasifikasi feedmil "${deleteData?.name}"?`}
          />
        )}
...
export default KlasifikasiFeedmilPage;
