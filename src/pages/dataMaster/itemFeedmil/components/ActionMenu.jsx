...
const ActionMenu = ({ item, onEdit, onDelete, onDetail, onClose, buttonRef }) => {
    ...
    const actions = [
        {
            ...
            description: 'Informasi lengkap item feedmil',
            bg: 'bg-blue-100',
            hoverBg: 'group-hover:bg-blue-200',
            text: 'text-blue-600',
        },
        {
            label: 'Edit Item Feedmil',
            icon: Edit,
            onClick: () => onEdit(item),
            className: 'text-gray-700',
            description: 'Ubah data item feedmil',
            bg: 'bg-amber-100',
        ...
        {
            label: 'Hapus Item Feedmil',
            icon: Trash2,
            onClick: () => onDelete(item),
            className: 'text-red-600',
            description: 'Hapus item feedmil permanen',
            bg: 'bg-red-100',
