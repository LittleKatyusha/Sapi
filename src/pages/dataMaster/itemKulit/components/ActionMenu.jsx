    ...
    const actions = [
        {
            ...
            description: 'Informasi lengkap item kulit',
            bg: 'bg-blue-100',
            hoverBg: 'group-hover:bg-blue-200',
            text: 'text-blue-600',
        },
        {
            label: 'Edit Item Kulit',
            icon: Edit,
            onClick: () => onEdit(item),
            className: 'text-gray-700',
            description: 'Ubah data item kulit',
            bg: 'bg-amber-100',
        ...
        {
            label: 'Hapus Item Kulit',
            icon: Trash2,
            onClick: () => onDelete(item),
            className: 'text-red-600',
            description: 'Hapus item kulit permanen',
            bg: 'bg-red-100',
