    ...
    const actions = [
        {
            ...
            description: 'Informasi lengkap jenis hewan',
            bg: 'bg-blue-100',
            hoverBg: 'group-hover:bg-blue-200',
            text: 'text-blue-600',
        },
        {
            label: 'Edit Jenis Hewan',
            icon: Edit,
            onClick: () => onEdit(row),
            className: 'text-gray-700',
            description: 'Ubah data jenis hewan',
            bg: 'bg-amber-100',
        ...
        {
            label: 'Hapus Jenis Hewan',
            icon: Trash2,
            onClick: () => onDelete(row),
            className: 'text-red-600',
            description: 'Hapus jenis hewan permanen',
            bg: 'bg-red-100',
