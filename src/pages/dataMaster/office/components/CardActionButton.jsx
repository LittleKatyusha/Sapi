    ...
    return (
        <div className="relative">
            <button
                ...
                tabIndex={0}
                className={`p-2 text-gray-400 hover:text-red-600 hover:bg-red-50 transition-all duration-200 rounded-xl hover:scale-110 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-opacity-50 group ${
                    openMenuId === item.pubid ? 'bg-red-50 text-red-600 scale-110' : ''
