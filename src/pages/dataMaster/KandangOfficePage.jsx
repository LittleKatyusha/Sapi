...
import { PlusCircle, Search, Filter, LayoutGrid, List, Building2, MapPin, Activity, Hash } from 'lucide-react';

// Import komponen UI yang sudah dipisahkan
import ActionButton from './office/components/ActionButton';
import CardView from './office/components/CardView';
...
import customTableStyles from './office/constants/tableStyles';
...
const KandangOfficePage = () => {
    ...
    const handleSave = useCallback(async (formData) => {
        try {
            ...
            if (editData) {
                ...
                result = await updateOffice(editData.pubid, formData);
            } else {
                // Create new office
    ...
    // Table columns configuration - Disederhanakan sesuai permintaan: Nomor, Nama, Deskripsi, Lokasi
            ...
            cell: row => (
                <div className="flex items-center">
                    ...
                    <div className="flex flex-col">
                        ...
                        <span className="text-xs text-gray-500">{getKategoriName(row.id_kategori)}</span>
                    </div>
                </div>
            )
        },
        ...
        },
        {
            ...
            cell: row => (
                <div className="flex items-center text-sm text-gray-600">
                    ...
                    <span className="truncate" title={row.location || 'Lokasi tidak tersedia'}>
                        {row.location || '-'}
                    </span>
                </div>
            )
    ...
    ], [openMenuId, handleEdit, handleDelete, handleDetail, getKategoriName]);
                    ...
                    <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                        <div>
                            ...
                            <p className="text-gray-600 text-sm sm:text-base">
                                Kelola dan pantau kandang serta office dengan mudah
                            </p>
                        </div>
                ...
                <div className="bg-white rounded-2xl p-3 sm:p-6 shadow-lg border border-gray-100">
                    <div className="flex flex-col gap-3 sm:flex-row sm:gap-4 sm:items-center sm:justify-between">
                        ...
                        <div className="relative flex-1 max-w-full sm:max-w-md">
                            ...
                            <input
                                type="text"
                                placeholder="Cari office/kandang..."
                                value={searchTerm}
                        ...
                        <div className="flex flex-wrap gap-2 sm:gap-3">
                            ...
                            >
                                <option key="all" value="all">
                                    {kategoriLoading ? 'Memuat...' : 'Semua Kategori'}
                                </option>
                        ...
                        <div className="flex items-start">
                            ...
                            <div className="flex-1">
                                ...
                                <p className="text-red-500 text-xs mt-2">
                                    💡 Menggunakan data dummy sebagai fallback. Klik "Test API" untuk memeriksa koneksi atau "Refresh Data" untuk mencoba lagi.
                                </p>
                            </div>
                        </div>
                    </div>
                                        ...
                                        <DataTable
                                            ...
                                            noDataComponent={
                                                <div className="text-center py-12">
                                                    ...
                                                    <p className="text-gray-500 text-lg">Tidak ada data office ditemukan</p>
                                                </div>
                                            }
                                            responsive
