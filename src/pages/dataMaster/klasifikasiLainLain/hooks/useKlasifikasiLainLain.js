...
const useKlasifikasiLainLain = () => {
  ...
  const API_BASE = API_ENDPOINTS.MASTER.KLASIFIKASI_LAIN_LAIN;

  const fetchKlasifikasiLainLain = useCallback(async (params = {}) => {
    setLoading(true);
    setError(null);
    try {
  ...
  const createKlasifikasiLainLain = useCallback(async (payload) => {
    setLoading(true);
    setError(null);
    try {
  ...
  const updateKlasifikasiLainLain = useCallback(async (pid, payload) => {
    setLoading(true);
    setError(null);
    try {
