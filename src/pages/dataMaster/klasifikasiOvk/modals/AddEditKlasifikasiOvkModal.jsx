...
const AddEditKlasifikasiOvkModal = ({ 
  item, 
  onClose, 
  onSave, 
  loading = false 
      ...
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-2xl max-h-[90vh] overflow-y-auto">
        ...
        <div className="flex items-center justify-between p-6 border-b border-gray-200">
          <h2 className="text-2xl font-bold text-gray-900">
            {item ? 'Edit Klasifikasi OVK' : 'Tambah Klasifikasi OVK'}
          </h2>
          <button
            onClick={onClose}
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-6">
          ...
          <div>
            ...
            <input
              ...
              placeholder="Masukkan nama klasifikasi OVK"
              disabled={isSubmitting}
              maxLength={200}
            />
            {errors.name && (
          ...
          <div>
            ...
            <textarea
              ...
              placeholder="Masukkan deskripsi klasifikasi OVK"
              disabled={isSubmitting}
            />
            {errors.description && (
              <p className="mt-1 text-sm text-red-600 flex items-center gap-1">
...
export default AddEditKlasifikasiOvkModal;
