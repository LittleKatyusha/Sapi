...
const PembayaranPage = () => {
    ...
    const handleEdit = (pembayaranItem) => {
        ...
        console.log('🔍 OVK Edit - has database id:', pembayaranItem.id);
        console.log('🔍 OVK Edit - has encryptedPid:', encryptedPid);
        ...
        console.log('🔍 OVK Edit - using encryptedPid:', encryptedPid);
        navigate(`/pembayaran/ovk/edit/${encodeURIComponent(encryptedPid)}`);
        setOpenMenuId(null);
    };
    ...
    const handleDetail = (pembayaranItem) => {
        ...
        console.log('🔍 OVK Detail - has database id:', pembayaranItem.id);
        console.log('🔍 OVK Detail - has encryptedPid:', encryptedPid);
        ...
        console.log('🔍 OVK Detail - using encryptedPid:', encryptedPid);
        navigate(`/pembayaran/ovk/detail/${encodeURIComponent(encryptedPid)}`);
        setOpenMenuId(null);
    };
