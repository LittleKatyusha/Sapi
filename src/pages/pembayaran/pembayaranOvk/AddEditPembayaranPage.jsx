...
const AddEditPembayaranPage = () => {
        ...
        if (isEdit && id && supplierOptions.length > 0 && officeOptions.length > 0 && farmOptions.length > 0 && !editDataLoaded.current) {
            const loadEditData = async () => {
                try {
                    ...
                    // Get both header and detail data from /details endpoint
                    ...
                    console.log('🔍 OVK API Response - showResponse.data:', showResponse.data);
                    console.log('🔍 OVK API Response - headerData.id:', headerData.id);
                    console.log('🔍 OVK API Response - headerData.pid:', headerData.pid);
                    ...
                    if (headerData) {
                        ...
                        console.log('🔍 OVK Loading edit data - API response headerData.id:', headerData.id);
                        console.log('🔍 OVK Loading edit data - parsed databaseId:', databaseId);
                        console.log('🔍 OVK Loading edit data - headerData.id type:', typeof headerData.id);
                        console.log('🔍 OVK Loading edit data - headerData.id === null:', headerData.id === null);
                        console.log('🔍 OVK Loading edit data - headerData.id === undefined:', headerData.id === undefined);
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            let result;
            if (isEdit) {
                console.log('🔍 OVK Edit mode - headerData.id:', headerData.id);
                console.log('🔍 OVK Edit mode - URL id parameter:', id);
                console.log('🔍 OVK Edit mode - submissionData:', submissionData);
                console.log('🔍 OVK Edit mode - submissionData.id:', submissionData.id);
                console.log('🔍 OVK Edit mode - isEdit:', isEdit);
                console.log('🔍 OVK Edit mode - headerData.id exists:', !!headerData.id);
