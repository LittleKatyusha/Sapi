...
/**
 * Hook untuk mengelola data pembayaran Kulit
 * Khusus untuk purchase_type = 4 (Kulit)
 */
const usePembayaran = () => {
    ...
    const fetchPembayaran = useCallback(async (page = 1, perPage = null, search = null, isSearchRequest = false, forceRefresh = false) => {
        console.log('🔄 Pembayaran Kulit Hook: fetchPembayaran called with params:', { page, perPage, search, isSearchRequest, forceRefresh });
        setLoading(true);
        setError(null);
        setSearchError(null);
        ...
        try {
            ...
            const apiUrl = `${API_ENDPOINTS.HO.PAYMENT.DATA}/?purchase_type=4&${finalParams}`;
            console.log('🔄 Pembayaran Kulit Hook: Making API call to:', apiUrl);
    ...
    const createPembayaran = useCallback(async (pembayaranData) => {
        ...
        try {
            ...
            formData.append('purchase_type', pembayaranData.purchase_type || 4);
    ...
    const updatePembayaran = useCallback(async (data) => {
        ...
        try {
            ...
            formData.append('purchase_type', data.purchase_type || 4);
            ...
            if (jsonData && jsonData.status === 'ok') {
                ...
                if (paymentData) {
                    ...
                    headerData = {
                        ...
                        purchase_type: paymentData.purchase_type || 4,
