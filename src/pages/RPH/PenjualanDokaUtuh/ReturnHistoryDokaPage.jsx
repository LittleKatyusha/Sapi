...
const ReturnHistoryDokaPage = () => {
  ...
  const fetchData = useCallback(async () => {
    ...
    try {
      ...
      const res = await HttpClient.get('/api/rph/return-penjualan-doka-utuh/history', { params });
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-gray-500 mt-0.5">
                Daftar semua transaksi return doka utuh
              </p>
            </div>
          </div>
        </div>
...
export default ReturnHistoryDokaPage;
