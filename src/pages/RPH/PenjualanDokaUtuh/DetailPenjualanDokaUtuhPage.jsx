...
const DetailPenjualanDokaUtuhPage = () => {
  const navigate = useNavigate();
  const { pid } = useParams();
  const { loading, fetchDetail } = usePenjualanDokaUtuh();
    ...
    <div className="min-h-screen bg-slate-50 p-4 sm:p-6">
      <div className="max-w-[1600px] mx-auto space-y-5">
        ...
        <nav className="flex items-center gap-1.5 text-xs text-gray-500">
          ...
          <button onClick={() => navigate('/rph/penjualan-doka-utuh')} className="hover:text-gray-700">
            Penjualan Doka Utuh
          </button>
          <span className="text-gray-300">/</span>
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-5 sm:p-6">
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
            <div className="flex items-start gap-4">
              <button
                onClick={() => navigate('/rph/penjualan-doka-utuh')}
            ...
            <div className="flex items-center gap-2 shrink-0">
              {data.status_transaksi === 'draft' && (
                <button
                  onClick={() => navigate(`/rph/penjualan-doka-utuh/edit/${pid}`)}
                ...
                {!data.details?.length && (
                  <tr>
                    <td colSpan="8" className="px-5 py-12 text-center text-gray-400">
                      ...
                      <p className="text-sm">Tidak ada detail doka</p>
                    </td>
                  </tr>
                )}
              </tbody>
...
export default DetailPenjualanDokaUtuhPage;
