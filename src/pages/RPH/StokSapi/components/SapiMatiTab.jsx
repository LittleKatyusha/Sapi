...
import { AlertCircle, Loader2, RefreshCw, AlertTriangle, Calendar, User } from 'lucide-react';
  ...
  return (
    <div className="space-y-4">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <h3 className="text-lg font-semibold text-slate-800">Riwayat Sapi Mati</h3>
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            disabled={loading}
            className="inline-flex items-center gap-1.5 rounded-lg bg-gradient-to-r from-slate-500 to-gray-600 px-4 py-2 text-sm font-semibold text-white shadow-sm hover:from-slate-600 hover:to-gray-700 focus:outline-none focus:ring-2 focus:ring-slate-500 focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed transition-all"
          >
