...
const PotongPaksaTab = () => {
  ...
  const fetchData = useCallback(async (opts = {}) => {
    ...
    try {
      ...
      const response = await StokSapiService.getPotongPaksaData(params);
    ...
    <div className="space-y-3">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2">
        ...
        <button
          ...
          disabled={loading}
          className="inline-flex items-center gap-2 rounded-md bg-red-500 px-4 py-2 text-sm font-medium text-white hover:bg-red-600 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
        >
          ...
          <div className="flex flex-1 flex-col gap-2 sm:flex-row sm:items-end">
            <div className="flex flex-1 flex-col gap-1.5">
              ...
              <input
                ...
                className="w-full rounded-md border border-gray-300 bg-white px-3 py-2 text-sm text-gray-700 focus:border-red-500 focus:outline-none focus:ring-1 focus:ring-red-500/30"
              />
            </div>
            <div className="flex flex-1 flex-col gap-1.5">
            ...
            <div className="flex gap-2">
              <button
                ...
                className="inline-flex items-center gap-2 rounded-md bg-red-500 px-4 py-2 text-sm font-medium text-white hover:bg-red-600 disabled:cursor-not-allowed disabled:bg-gray-300"
              >
        ...
        <table className="min-w-full divide-y divide-gray-200 text-sm">
          <thead className="bg-gradient-to-r from-red-50 to-rose-50">
            <tr>
              ...
              <th className="px-3 py-2 text-left text-xs font-semibold text-slate-600 uppercase tracking-wider">Bobot Selisih</th>
                ...
                <tr key={item.pubid || index} className="hover:bg-slate-50 transition-colors">
                  ...
                  <td className="px-3 py-2 border-gray-100 whitespace-nowrap">
                    <div className="space-y-0.5">
                      <div className="text-sm text-slate-700">{item.tgl_potong_paksa || '-'}</div>
                  ...
                  <td className="px-3 py-2 text-sm text-slate-700 border-gray-100 whitespace-nowrap">
                  ...
                  <td className="px-3 py-2 border-gray-100 whitespace-normal max-w-xs truncate">
                    <div className="space-y-0.5">
                      <div className="text-xs text-slate-500">
                        <span className="text-slate-400">Sebab:</span> {item.sebab_potong_paksa || '-'}
                      </div>
