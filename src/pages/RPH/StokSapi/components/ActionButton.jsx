  ...
  return (
    <div className={`relative ${isActive ? 'active-row' : ''}`}>
      <button
        ...
        tabIndex={0}
        className={`p-2.5 text-gray-600 bg-white border border-gray-300 shadow-sm hover:text-blue-600 hover:bg-blue-50 hover:border-blue-300 transition-all duration-150 rounded-lg hover:scale-105 hover:shadow-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50 group ${
