      ...
      <div className="w-full max-w-md overflow-hidden rounded-3xl bg-white shadow-2xl">
        <div className="p-6 text-center">
          ...
          <p className="mt-2 text-sm leading-6 text-slate-500">
            Data pemberian pakan untuk <span className="font-semibold text-slate-700">{row.nama_sapi || 'sapi ini'}</span> akan dihapus. Tindakan ini tidak dapat dibatalkan.
          </p>
        </div>
...
const PemberianPakanSapiPage = () => {
  ...
  const statCards = useMemo(() => {
    ...
    const uniqueSapi = new Set(rows.map((row) => row.eartag_sapi).filter(Boolean)).size;
    ...
    return [
      ...
      { label: 'Sapi Unik', value: `${uniqueSapi} ekor`, tone: 'cyan' },
            ...
            <div className="flex flex-col gap-2 sm:flex-row sm:items-center">
              <div className="relative min-w-[240px] flex-1 xl:w-96">
                ...
                <input
                  ...
                  placeholder="Cari sapi, eartag, resep, peternak..."
