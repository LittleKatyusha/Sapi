  ...
  return <div className="min-h-screen bg-slate-50"><div className="space-y-6 px-4 py-5 sm:px-6 lg:px-8">
    ...
    <div className="rounded-3xl border border-slate-200 bg-white p-5 shadow-lg">
      <div className="relative w-full max-w-xl">
        ...
        <input value={search} onChange={e => { setPage(1); setSearch(e.target.value); }} placeholder="Cari no kwitansi, pedagang, atau RPH" className="w-full rounded-2xl border border-slate-300 py-3 pl-10 pr-10 text-sm outline-none transition focus:border-rose-500 focus:ring-2 focus:ring-rose-500/20"/>
