...
import usePenjualanKarkas from './hooks/usePenjualanKarkas';
import AddEditKarkasModal from './modals/AddEditKarkasModal';
import DetailKarkasModal from './modals/DetailKarkasModal';
import DeleteConfirmKarkasModal from './modals/DeleteConfirmKarkasModal';
...
const PenjualanKarkasPage = () => {
  ...
  const handleStore = async (payload) => {
    ...
    if (res.success) {
      setNotification({ type: 'success', message: 'Penjualan Karkas berhasil ditambahkan' });
  ...
  const handleUpdate = async (payload) => {
    ...
    if (res.success) {
      setNotification({ type: 'success', message: 'Penjualan Karkas berhasil diperbarui' });
      ...
      <div className="w-full mx-auto px-0 py-4 sm:py-6 space-y-6">
        ...
        <div className="bg-white rounded-lg p-4 sm:p-6 shadow-xl border border-gray-100 mx-4 sm:mx-6 lg:mx-8">
          <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            <div>
              <h1 className="text-2xl sm:text-3xl font-bold text-gray-800">Penjualan Karkas</h1>
              <p className="text-gray-600 text-sm sm:text-base">Kelola transaksi penjualan karkas RPH</p>
            </div>
            <button
        ...
        <div className="bg-white shadow-lg border-y border-gray-100 relative overflow-hidden mx-4 sm:mx-6 lg:mx-8 rounded-lg">
          <div className="px-4 py-3 bg-gray-50 border-b border-gray-200 flex items-center justify-between">
            <span className="text-sm text-gray-600">Data Penjualan Karkas</span>
              ...
              noDataComponent={
                <div className="text-center py-12">
                  {error ? (
                    ...
                    <p className="text-gray-500">Tidak ada data penjualan karkas</p>
                  )}
                </div>
              }
              responsive={false}
...
export default PenjualanKarkasPage;
