  ...
  return (
    <div className="min-h-screen bg-slate-50 p-4 md:p-6">
      ...
      <div className="mb-4 grid gap-3 rounded-lg border bg-white p-4 md:grid-cols-5">
        <div className="relative md:col-span-2"><Search className="absolute left-3 top-2.5 h-4 w-4 text-slate-400" /><input className={`${inputClass} pl-9`} placeholder="Cari no kwitansi / pedagang / RPH" value={filters.search} onChange={(e) => setFilters((c) => ({ ...c, search: e.target.value }))} /></div>
