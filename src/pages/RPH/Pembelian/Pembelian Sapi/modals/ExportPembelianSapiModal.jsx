            ...
            <div className="bg-white rounded-2xl shadow-2xl w-full max-w-lg max-h-[90vh] overflow-y-auto" style={{ zIndex: 10001 }}>
                ...
                <div className="p-6 space-y-4">
                    ...
                    <div className="bg-gray-50 rounded-lg p-2.5 text-xs text-gray-600 flex items-center justify-between">
                        ...
                        <span className={`font-medium ${hasDateRange ? 'text-emerald-600' : 'text-red-500'}`}>{hasDateRange ? 'Periode dipilih' : 'Pilih periode dahulu'}</span>
                    </div>
                </div>
                ...
                <div className="flex items-center justify-between gap-3 p-6 border-t border-gray-200 sticky bottom-0 bg-white rounded-b-2xl">
                    ...
                    <div className="flex gap-2">
                        ...
                        <button onClick={handleConfirm} disabled={loading || !!rangeError || !hasDateRange} className={`px-4 py-2 text-sm font-medium text-white rounded-lg transition-colors disabled:cursor-not-allowed flex items-center gap-2 ${format === 'excel' ? 'bg-emerald-600 hover:bg-emerald-700 disabled:bg-emerald-400' : 'bg-red-600 hover:bg-red-700 disabled:bg-red-400'}`}>
