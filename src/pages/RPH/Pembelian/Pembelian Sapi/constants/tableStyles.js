...
const enhancedTableStyles = {
    ...
    headCells: {
        style: {
            ...
            // Remove sticky positioning for better full-width layout
        }
    },
    rows: {
        style: {
            ...
            transition: 'all 0.2s ease',
            '&:hover': {
                backgroundColor: '#d1d5db', // Even darker hover effect for better visibility
            ...
            '&:nth-of-type(even)': {
                backgroundColor: '#e5e7eb', // Darker gray for even rows (more visible)
            }
        },
        highlightOnHoverStyle: {
            backgroundColor: '#d1d5db', // Consistent hover color (darker)
    ...
    cells: {
        style: {
            ...
            verticalAlign: 'middle',
            borderRight: '1px solid #e5e7eb', // Slightly darker border for better visibility
            backgroundColor: 'transparent', // Ensure cells inherit row background
            '&:last-child': {
                borderRight: 'none', // No border on last column
            },
