...
import { PlusCircle, Eye, Edit, Trash2, X, MoreVertical, AlertTriangle, Home } from 'lucide-react';

// Mengimpor komponen StatusBadge dari file terpisah
import StatusBadge from '../components/StatusBadge';

// --- MODAL-MODAL UNTUK HALAMAN INI ---
                    ...
                    <table className="min-w-full w-full text-sm text-left text-gray-600">
                        <thead className="text-xs text-gray-700 uppercase bg-gray-100">
                            <tr>
                                ...
                                <th className="px-6 py-3 whitespace-nowrap hidden sm:table-cell">Kandang</th>
                            ...
                            {allLivestockData.map(cow => (
                                <tr key={cow.id} className="border-b hover:bg-gray-50">
                                    ...
                                    <td className="px-6 py-4 whitespace-nowrap">
                                        <div>{cow.breed}</div>
                                        <div className="sm:hidden text-xs text-gray-500 font-semibold mt-1 flex items-center"><Home size={12} className="mr-1"/>{cow.kandang}</div>
                                    </td>
                                    <td className="px-6 py-4 whitespace-nowrap hidden sm:table-cell">{cow.kandang}</td>
